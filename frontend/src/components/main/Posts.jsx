    ...
    <div className="flex flex-col  bg-white rounded-2xl p-3">
      <div className="flex gap-2 items-center pb-3">
        ...
        <div className="flex flex-col content-center">
          <h1 className="text-base font-medium">Bryan Price</h1>
          <h2 className="text-xs">India, 12 min ago</h2>
        </div>
      </div>
      <div className=" pb-1">
        <img className="object-cover w-full rounded-2xl " src={bike} alt="" />
      </div>
      ...
      <div className="text-sm">
        <h2>
          Liked by <b>Shreyas</b> and <b>52</b> others
        </h2>
        <h2>
          <b>Bryan Price</b> Lorem ipsum dolor
        </h2>
        <h2 className="text-slate-500">View all 120 comments</h2>
      </div>
    </div>
  );
}
